...
public  interface StudentRepository extends JpaRepository<Student, Integer> {
    ...
    @Query("SELECT new com.estudiante.estudiante.DTO.DTOStudentsWithCity(e.collegeNotebook, e.surname, e.name, e.city) FROM Student e JOIN Courses cu ON e.collegeNotebook = cu.collegeNotebook JOIN Career ca ON cu.id_career = ca.id_career WHERE e.city = :city AND ca.name = :withCareer")
